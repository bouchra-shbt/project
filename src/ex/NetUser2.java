...
import java.util.*;
public class NetUser2 extends GridSim
{
     ...
     *                      initialized GridSim.
     */
    public NetUser2(String name, String destName, Link link,double D,double[] s) throws Exception
    {
        super(name, link);
    ...
    public void body()
    {
        ...
        for (i = 0; i < size; i++)
        {
            ...
            super.send(super.output, GridSimTags.SCHEDULE_NOW,NetUser2.SEND_MSG, data);
        }
        ////////////////////////////////////////////////////////
        // get the ack back
        Object obj = null;
